  ...
  <div class="app-container">
    <div class="table-container">
      ...
      >
        ...
        <el-table-column align="center" label="审查员openid" width="200">
          <template slot-scope="scope">
            {{ scope.row.content }}
          </template>
        </el-table-column>
        <el-table-column align="center" label="审查员ID" width="200">
          <template slot-scope="scope">
            {{ scope.row.content }}
          </template>
        </el-table-column>
        <el-table-column label="权限截止日期" align="center" width="180">
          <el-date-picker
            style="width: 150px"
            v-model="permissionDeadline"
            type="date"
            placeholder="选择日期"
            size="small"
            width="150"
